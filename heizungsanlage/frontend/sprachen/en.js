...
window.SPRACHEN.en = {
  ...
  "Aufheizung": "heat-up",
  "Katalog": "catalogue",
  "Stellen kommt nicht an.": "Writing is not getting through.",
  "Übersicht anpassen": "Customise the overview",
  "Anpassen beenden": "Done customising",
  "Parameter hinzufügen": "Add a parameter",
  "Beschriftung": "Label",
  "wie der Parameter": "as the parameter is called",
  "Hinzufügen": "Add",
  "Übersicht speichern": "Save the overview",
  "Vorschlag laden": "Load the proposal",
  "Vorschlag geladen – noch nicht gespeichert": "Proposal loaded – not saved yet",
  "Übersicht gespeichert": "Overview saved",
  "Zurück auf den Vorschlag": "Back to the proposal",
  "entfernen": "remove",
  "Keine Kachel übrig. Gespeichert heißt das: zurück zum Vorschlag.":
    "No tile left. Saving that means: back to the proposal.",
  "Eigenen Namen vergeben": "Give it a name of your own",
  "Name gespeichert": "Name saved",
  "Name aus der Liste gilt wieder": "The name from the list applies again",
  "unbekannt": "unknown",
  ...
  [/^(\d+) Schreibversuche hintereinander sind ohne Wirkung geblieben\. Die Anlage behält, was zuletzt gesetzt wurde\.$/,
   "$1 write attempts in a row had no effect. The system keeps whatever was set last."],
  [/^Zuletzt: Parameter (\S+) – (.+)$/, "Last: parameter $1 – $2"],
  [/^laut Liste: (.+)$/, "per the list: $1"],
  [/^Eigener Name für Parameter (\S+)\. Leer lassen heißt: den Namen aus der Liste verwenden \(„(.+)“\)\.$/,
   "A name of your own for parameter $1. Leaving it empty means: use the name from the list (“$2”)."],
  [/^alle (\d+)$/, "every $1"],
