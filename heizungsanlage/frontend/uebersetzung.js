...
// Übernommen aus dem Heizungsplaner; dieselbe Idee, dieselben Fallen.
//
...
/**
 * Einen einzelnen Satz übersetzen.
 *
 * Für alles, was nicht im Dokument steht und deshalb am Beobachter
 * vorbeigeht: die Rückfragen von `confirm()` vor allem. Die zeigt der Browser
 * selbst an, nicht die Seite – ohne diesen Weg blieben ausgerechnet die
 * Sicherheitsabfragen deutsch.
 */
window.uebersetzeText = (text) => _uebersetze(text) ?? text;
